...
INSERT INTO `document` VALUES (1,1,'Time and Space Complexity','note','2025-10-13 18:00:00',NULL),(2,2,'Object-Oriented Programming Concepts','note','2025-10-14 22:12:25',NULL);
...
CREATE TABLE `note` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_notes_id` FOREIGN KEY (`id`) REFERENCES `document` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pdf` (
  ...
  `size` int NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_pdfs_id` FOREIGN KEY (`id`) REFERENCES `document` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (1,'john@gmail.com','john','John',NULL,'2025-10-13 18:00:00',NULL),(2,'mary@gmail.com','mary','Mary',NULL,'2025-10-22 18:00:00',NULL);
...
-- Dump completed on 2025-10-14 20:25:03
